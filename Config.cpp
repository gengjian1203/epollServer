...
int CConfig::GetConfigStringValue(char *pInFileName,char *pInSectionName,char *pInKeyName,char *pOutKeyValue)
{
    FILE *fpConfig;
    char szBuffer[150];
    char *pStr1,*pStr2;
...
/*区分大小写*/
int CConfig::CompareString(char *pInStr1,char *pInStr2)
{
...
int CConfig::GetKeyValue(FILE *fpConfig,char *pInKeyName,char *pOutKeyValue)
{
    char szBuffer[150];
...
int CConfig::GetConfigIntValue(char *pInFileName,char *pInSectionName,char *pInKeyName,int *pOutKeyValue)
{
    int iRetCode = 0;
